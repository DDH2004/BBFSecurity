...
import { type CounterContract, type CounterProviders, type DeployedCounterContract } from './common-types.js';
...
export declare const isAnotherChain: (wallet: Wallet, offset: number) => Promise<boolean | undefined>;
